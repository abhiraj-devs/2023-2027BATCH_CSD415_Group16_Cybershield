...
export default function AlertsView() {
  ...
  const handleSaveSettings = async () => {
    try {
      ...
      console.error(e);
      triggerNotice("Failed to save notification settings.");
    }
  };
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                      ...
                      {!alert.acknowledged && (
                        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                          <button
                            onClick={() => { triggerNotice("Action initiated: Initiating automated forensic investigation timeline..."); handleAck(alert.id); }}
                          ...
                          <button
                            onClick={() => { triggerNotice("Action initiated: Added indicator to global whitelist and closed alert."); handleAck(alert.id); }}
                          ...
                          <button
                            onClick={() => { triggerNotice("Action initiated: Target isolated and quarantined from network."); handleAck(alert.id); }}
